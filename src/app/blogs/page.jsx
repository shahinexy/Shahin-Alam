    ...
    <div className="max-w-6xl mx-auto h-screen px-4 pb-20 mt-10">
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 text-center mt-20">
        ...
        <div class="relative h-[350px] group duration-500 cursor-pointer group overflow-hidden text-gray-50 hover:duration-700 ">
          <div class=" bg-lime-400 text-gray-800">
          <Image
              className="h-72"
              src={react}
              alt="Logo"
          ...
          <div class="absolute bg-gray-50 -bottom-16 p-3 flex flex-col gap-1 group-hover:-bottom-0 group-hover:duration-600 duration-500">
            <span class="text-primary font-bold text-xl">What is React? Why should we use React for the front-end?</span>
            <span class="flex justify-center mt-3"><Link href={`https://www.linkedin.com/pulse/what-react-why-should-we-use-front-end-shahin-alam-t57ue/?trackingId=6tvFdsQxQ1a%2BCMtrhFRc%2Fw%3D%3D`} target="_blank"><button className="flex gap-2 items-center text-xl text-primary hover:bg-primary hover:text-white duration-500 border border-primary px-7 py-1">View <MdArrowOutward /> </button></Link></span>
          </div>
        </div>
